...
<html>
  ...
  <body>
  	<s:form id='form' action='save!save.action' namespace='/patrol' onsubmit="return checkspans();">
  		<table>
  			<th colspan="2"><center>巡检记录</center></th>
  			<tr>
  				<td>巡检项目</td>
  				<td>
  				${tHtml}
  			...
  			<tr>
  				<td>巡检日期</td>
  				<td>
  					<input id="patrolTime" name="patrolTime" onclick="WdatePicker()" onblur="checkNull(this.id,'span3')"/>
  			...
  			<tr>
  				<td>巡检内容</td>
  				<td>
	  				<input id="content" name="content" onblur="checkNull(this.id,'span4')"/>
  			...
  			<tr>
  				<td>巡检结果</td>
  				<td>
	  				<textarea id="result" name="result" cols="110" rows="4" onblur="checkNull(this.id,'span5')"></textarea>
