...
<html>
  ...
  <body>
	  <s:form id="form" action="modify!modify.action" namespace="/certificate">
		<table>
			<tr>
			...
			<tr>
  				...
  				<td>
  					...
  					<input type="hidden" id="sid" name="sid" value="${certificate.sid }" />
  			...
  			<tr>
  				<td>编号代码</td>
  				<td>
  					<input type="text" id="no" name="no" value="${certificate.no }" />
  				</td>
  			</tr>
  			<tr>
  				<td>发证单位</td>
  				<td>
  					<input type="text" id="unit" name="unit" value="${certificate.unit }" />
  				</td> 
  			</tr>
  			<tr>
  				<td>有效截止日期</td>
  				<td>
  					<input type="text" id="validate" name ='validate' value="${certificate.validate }" onclick="WdatePicker();"/>
  				</td>
  			</tr>
			<tr>
				<td colspan="2">
