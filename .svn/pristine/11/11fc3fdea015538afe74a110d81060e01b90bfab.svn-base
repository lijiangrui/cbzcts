...
public class Supplier {
	...
	private List<Certificate> clist= new ArrayList<Certificate>();
	private List<Product> plist= new ArrayList<Product>();
	private List<Patrol> palist = new ArrayList<Patrol>();
	private List<Charge> chlist = new ArrayList<Charge>();
	...
	public List<Patrol> getPalist() {
		return palist;
	}
	public void setPalist(List<Patrol> palist) {
		this.palist = palist;
	}
	public List<Charge> getChlist() {
		return chlist;
	}
	public void setChlist(List<Charge> chlist) {
		this.chlist = chlist;
	}
}
